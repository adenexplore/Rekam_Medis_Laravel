      ...
      <div id="content">
        ...
        <div class="container-fluid">
                  ...
                  if($ggl){
                    ...
                    $det=mysqli_query($conn, "select * from pasien where id='$id_brg'")or die(mysql_error());
          ...
          <div class="row ml-5">
            <div class="col-md-10 col-sm-12 col-xs-12">
              <h2><center>Info Detail Pasien</center></h2>
          	<table class="table">
          ...
          <?php
           ...
           <div class="col-md-3">
           <a href="tab_pasien.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
           </div>
